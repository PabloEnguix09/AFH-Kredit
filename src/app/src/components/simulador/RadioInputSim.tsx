        ...
        <div className={styles.radioInput}>
            ...
            <div className={styles.opciones}>
                <div className={styles.opcion}>
                    <input type="radio" name={opcion1} id={opcion1} value={opcion1} onChange={e => estadoCb(e.currentTarget.value)} checked={estado === opcion1}/>
                    <label htmlFor={opcion1}>{opcion1}</label>
                </div>
                <div className={styles.opcion}>
                    <input type="radio" name={opcion2} id={opcion2} value={opcion2} onChange={e => estadoCb(e.currentTarget.value)} checked={estado === opcion2}/>
